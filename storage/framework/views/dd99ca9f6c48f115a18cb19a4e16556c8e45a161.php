    ...
    <div class="all-products-container">
      <?php $__currentLoopData = $obats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $obat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="single-product-container">
            <a href="/admin/edit-obat/<?php echo e($obat->id); ?>"><img src="<?php echo e(Storage::url($obat->obat_photo)); ?>" alt="gambar obat" width="307px" height="257px" class="img-single-obat"></a>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\christian.wiranata\Desktop\Porject SE\resources\views/admin/home.blade.php ENDPATH**/ ?>