<nav>
  ...
  <div class="fav-transaction">
    <a href="/user/favorite"><button class="favorite-btn"><img src="<?php echo e(asset('assets/User/favorite.png')); ?>" alt="Favorite" width="30px" height="30px"></button></a>
    <a href="/user/transaction"><button class="transaction-btn"><img src="<?php echo e(asset('assets/User/transaction.png')); ?>" alt="Transaction" width="30px" height="30px"></button></a>
  </div>
...
</nav><?php /**PATH C:\Kuliah\Software Engineering\Project\Sehatin\resources\views/components/user-navbar.blade.php ENDPATH**/ ?>