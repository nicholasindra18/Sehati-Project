...
<body>
    <div class="main-container">
        ...
        <div class="inner-container">
            <img src="{{ Storage::url($transaction->obat->obat_photo)}}" alt="Gambar Kue" width="303px" height="255px" class="img-kue">
            <div class="payment-detail">
                <div class="display-kanan">
                    <div><b>Medicine Name: {{ $transaction->obat->obat_name }}</b></div>
                </div>
                <div class="display-kanan">
                    <div>Subtotal Product: {{ $transaction->quantity * $transaction->obat->obat_price }}</div>
                </div>
                <div class="display-kanan">
                ...
                <div class="total-harga">
                    <div>Total Pesanan: {{ ($transaction->quantity * $transaction->obat->obat_price) + 2500 }}</div>
                </div>
