<nav>
  ...
  <div class="home-fav-transaction">
    <a href="/user/favorite"><button class="favorite-btn"><img src="{{ asset('assets/User/favorite.png') }}" alt="Favorite" width="25px" height="25px"></button></a>
    <a href="/user/transaction"><button class="transaction-btn"><img src="{{ asset('assets/User/transaction.png') }}" alt="Transaction" width="25px" height="25px"></button></a>
  </div>
